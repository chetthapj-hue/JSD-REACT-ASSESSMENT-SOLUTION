          ...
          {authLoading ? (
            ...
            <>
              <span className="text-base">
                Logged in as <span>{user.usernane}</span>
              </span>
            ...
            <form onSubmit={handleSummit} className="flex items-center gap-x-2">
              <input
                value={email}
              ...
              />
              <button type="submit" disabled={submitting} className="cursor-pointer bg-sky-500 hover:bg-sky-600 disabled:bg-sky-300 text-white px-3 py-1 rounded-xl text-base">
                Login
              </button>
            </form>
          )}
